<script>
  ...
  import { authStore, cartStore, isAuthenticated } from '../lib/stores/index.js';
...
<div class="auth-page min-h-screen flex items-center justify-center py-12 px-4">
  ...
  <div class="w-full max-w-sm relative z-10">
    ...
    <div class="auth-card">
      ...
      {#if sessionExpired}
        <div class="bg-amber-50 text-amber-700 px-3 py-2 rounded-lg mb-4 text-xs border border-amber-200">
          <span class="font-medium">Session expired.</span> Please sign in again to continue.
        </div>
      {/if}

...
import com.gdn.project.waroenk.cart.exceptions.DuplicateResourceException;
...
public class GrpcControllerAdvice {
  ...
  public StatusRuntimeException handleAuthorizationException(AuthorizationException ex) {
